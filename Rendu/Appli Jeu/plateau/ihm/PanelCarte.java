...
// Dessine la carte COMMUNE courante (la même pour tous les joueurs), style "carte à jouer".
public class PanelCarte extends JPanel
{
	...
	protected void paintComponent(Graphics g)
	{
		...
		// --- Pas de carte (pioche épuisée) : dos de carte ---
		if (carte == null)
		{
		...
		g2d.setStroke(new BasicStroke(2));
		g2d.setColor(carte.estFoncee() ? new Color(100, 100, 200) : new Color(120, 120, 180));
		g2d.drawRoundRect(5, 5, w - 10, h - 10, 15, 15);
